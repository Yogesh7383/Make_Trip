...
<%--<%@include file="sidebar.jsp" %>--%>
                ...
                <a href="feedback.jsp"> View Feedback </a>
                       ...
                       <div class="main-content" style="margin-left: 25%; margin-top: 10%; ">
    
                <!-- Main content -->



                <h1> User Hotel Booking Detail</h1>
                <table border="3">
                    <tr>
                        <th> Hotel User ID </th>
                        <th> Hotel User Name</th>
                        <th> Hotel User Email</th>
                        <th> Room Type</th>
                        <th> Total Rooms</th>
                        <th> Price Per Total Room</th>
                    ...
                    <%
                        ...
                        try {
                            ...
                            rs = stmt.executeQuery("SELECT * FROM hbooking");
                    ...
                    <tr>
                        ...
                        <td><%= rs.getString("htype")%></td>
                        <td><%= rs.getString("t_rooms")%></td>
                        <td><%= rs.getString("price")%></td>

                        <td> <a href="deletehbooking.jsp?hid=3">cancel</a></td> 
                    </tr>
