...
<%--<%@include file="sidebar.jsp" %>--%>
    ...
    <h1> User Package Booking Detail</h1>
    <table border="3">
        <tr>
            <th> ID </th>
            <th>name</th>
    ...
    PreparedStatement preparedStatement = null;
        ...
        <tr>
            ...
            <td><%= rs.getString("badults") %></td>
            <td><%= rs.getString("bpickup") %></td>
            <td><%= rs.getString("bpackage") %></td>
            <td><%= rs.getString("bpayment") %></td>
           <td> <a href="deletebooking.jsp?bid=2">cancel</a></td> 
        </tr>
