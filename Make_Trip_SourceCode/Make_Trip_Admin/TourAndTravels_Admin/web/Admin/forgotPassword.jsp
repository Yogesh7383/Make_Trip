			...
			<div class="col-lg-8 col-md-10">
				...
				<form class="card mt-4" method="POST">
					...
					<div class="card-footer">
                                            <button class="btn btn-success" type="submit"><a href="EnterOtp.jsp" style="color:white;">Get New
                                                        Password</a></button>
                                            <button class="btn btn-danger" type="submit"><a href="login.jsp" style="color:white;">Back to
							Login</a></button>
					</div>
				</form>
			</div>
